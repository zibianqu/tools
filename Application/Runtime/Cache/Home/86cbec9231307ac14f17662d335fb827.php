...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title>ip/域名地址查询 - <?php echo C('site_name');?></title>
	<meta name="keywords" content="ip地址查询,域名ip地址查询,域名查询,域名地址查询"/>
	<meta name="description" content="ip地址查询,域名ip地址查询,域名查询,域名地址查询"/>
...
<div class="new_content zerogrid">
	...
	<div class="new_tool">
		...
		<div class="new_br"></div>
		<div class="new_tool_ iplocation">
			<form action="" method="post">
			<p>
				<input type="text" name="ip" id="ip" value="<?php echo ($ip); ?>" class="input3" placeholder="请输入ip或域名"/>
				<button class="button2">查询</button>
			</p>
			 <p>
			 	<span>您的ip：</span> <?php echo ($res["ip"]); ?>
			 </p>
			 <p>
			 	<span>您的地址：</span><?php echo ($res["country"]); ?>
			 </p>
			 </form>
		</div>
	</div>
