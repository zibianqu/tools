...
class ClassWebsocketTool{
	...
	**/
	function __construct( $host = '', $port = '', $path = '/' ) {
		...
		$this->class[WEBSOCKET_TYPE_1] = new ClassWebsocket1Tool();
		$this->class[WEBSOCKET_TYPE_2] = new ClassWebsocket2Tool;
		$this->class[WEBSOCKET_TYPE_API] = new ClassWebsocketApiTool();
	}
